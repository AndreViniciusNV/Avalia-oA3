...
import com.unifacs.a3_engsoftware.JAVA.Eventos.EventosDAO;
            ...
            EventosController evento = new EventosController();
                ...
                if (evt.getClickCount() == 2) {
                    ...
                    if (row != -1) { // Verifica se uma linha foi selecionada
                        ...
                        String nomeEvento = (String) jTableListaEventos.getValueAt(row, 2); // Supondo que o nome do
                                                                                            // evento está na coluna 1
                        int codigoEvento = (int) jTableListaEventos.getValueAt(row, 0); // Supondo que o código do
                                                                                        // evento está na coluna 0
                            ...
                            if (confirm == JOptionPane.YES_OPTION) {
                                try {
                                    if(evento.verificarUsuario(usuarioLogado.getCodUser(), codigoEvento)) {
                                        ...
                                        JOptionPane.showMessageDialog(
                                            ListaEventos.this,
                                            "Você já está inscrito no evento '" + nomeEvento + "'.",
                                            "Aviso",
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 378,
